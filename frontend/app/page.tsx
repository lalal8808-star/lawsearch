...
import { Scale, ShieldCheck, Download, Zap, User, Bell } from "lucide-react";
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar">
          <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-12">
              <section>
                <motion.div
                  ...
                  className="mb-8"
                >
                  <h1 className="text-5xl font-black mb-4 text-gradient tracking-tight leading-tight uppercase">Legal Analysis Engine</h1>
                  <p className="text-muted text-[14px] leading-relaxed font-medium">
                    국가법령정보센터의 실시간 법령 정보와 사용자의 문서를 기반으로 <br />
                ...
                <div className="grid grid-cols-3 gap-4 mb-12">
                  {[
                    ...
                    <div key={idx} className="glass-card p-4 flex flex-col items-center text-center group hover:border-primary/50 transition-colors">
                      ...
                      <span className="text-[9px] text-muted font-bold">{item.sub}</span>
                    </div>
                  ))}
                </div>
              </section>
            ...
            <div className="lg:col-span-7 h-[650px] lg:sticky lg:top-8">
              <AIPanel />
            </div>
          </div>
